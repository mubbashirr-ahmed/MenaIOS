...
open class DropDown: UITextField {
    ...
    @IBInspectable public var selectedRowColor: UIColor = UIColor(named: "Primary") ?? .purple//.systemPink
    ...
    @IBInspectable public var arrowColor: UIColor = UserDefaults.standard.bool(forKey: "isDarkMode") ? .white : .black {
        didSet {
...
extension DropDown: UITableViewDataSource {
    ...
    public func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if indexPath.row != selectedIndex {
            ...
            cell!.textLabel!.textColor = rowBackgroundColor
        }
...
class Arrow: UIView {
    ...
    var arrowColor: UIColor = UserDefaults.standard.bool(forKey: "isDarkMode") ? .white : .black{
        didSet {
