...
class OnboardingPageViewController: UIPageViewController {
    ...
    var pageTitle = [Constants.string.pageTitle1.localize(), Constants.string.pageTitle2.localize(), Constants.string.pageTitle3.localize()]
    
    var pageImages: [UIImage] = [UIImage(named: "welcome1")!,UIImage(named: "welcome2")!,UIImage(named: "welcome3")!]
    
    var pageStepper: [UIImage] = [UIImage(named: "stepper1")!,UIImage(named: "stepper2")!,UIImage(named: "stepper3")!]
    
    var pageDescriptionText = [Constants.string.pageDescriptionText1.localize(), Constants.string.pageDescriptionText2.localize(), Constants.string.pageDescriptionText3.localize()]
